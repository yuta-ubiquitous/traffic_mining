...
if __name__ == "__main__":
	...
	output_name = "./traffic_data/trafic_data_bicycle.json"
	...
	for data in dict_list:
		...
		key = u"当事者種_1"
		vehicle1_type = data[key].split(u"　")[0]
		if(vehicle1_type == u"乗用車"):
			item_dict[u"加害車種"] = vehicle1_type
		else:
			continue
		
		key = u"当事者種_2"
		vehicle2_type = data[key].split(u"　")
		
		if(len(vehicle2_type) == 1):
			continue
